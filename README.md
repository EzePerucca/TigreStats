# Estadísticas del Club Atlético Tigre
...
- **SCSS**: Para una estilización moderna y responsiva.

## Instalación y Pasos para el Desarrollo Local
1. Clona el repositorio:
   ```
   git clone https://github.com/EzePerucca/TigreStats.git
   ```
...
- `dist/`: Contiene los archivos compilados para producción.
...
Para más detalles o consultas, puedes contactar a [EzePerucca](https://github.com/EzePerucca).
